...
create unique index IX_8C5B3496 on StyleBookEntry (groupId, head, ctCollectionId, uuid_[$COLUMN_LENGTH:75$]);
...
create unique index IX_C4DE74F2 on StyleBookEntryVersion (groupId, version, ctCollectionId, uuid_[$COLUMN_LENGTH:75$]);
