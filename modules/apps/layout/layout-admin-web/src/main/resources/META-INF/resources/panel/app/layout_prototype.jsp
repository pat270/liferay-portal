...
PortletURL editLayoutURL = PortalUtil.getControlPanelPortletURL(request, LayoutAdminPortletKeys.LAYOUT_PROTOTYPE_PAGE, 0, PortletRequest.RENDER_PHASE);
...
<aui:a cssClass="layout-tree " data="<%= data %>" href="<%= editLayoutURL.toString() %>" label="<%= selLayout.getName(locale) %>" />