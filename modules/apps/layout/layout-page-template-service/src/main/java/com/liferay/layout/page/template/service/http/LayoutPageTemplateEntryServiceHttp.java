...
public class LayoutPageTemplateEntryServiceHttp {
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				LayoutPageTemplateEntryServiceUtil.class,
				"getLayoutPageTemplateEntriesByType",
				_getLayoutPageTemplateEntriesByTypeParameterTypes37);
	...
	public static int getLayoutPageTemplateEntriesCountByType(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getLayoutPageTemplateEntriesCountByTypeParameterTypes54);
	...
	public static com.liferay.layout.page.template.model.LayoutPageTemplateEntry
		...
		try {
			MethodKey methodKey = new MethodKey(
				LayoutPageTemplateEntryServiceUtil.class,
				"getLayoutPageTemplateEntry",
				_getLayoutPageTemplateEntryParameterTypes55);
	...
	public static com.liferay.layout.page.template.model.LayoutPageTemplateEntry
		...
		try {
			MethodKey methodKey = new MethodKey(
				LayoutPageTemplateEntryServiceUtil.class,
				"getLayoutPageTemplateEntry",
				_getLayoutPageTemplateEntryParameterTypes56);
	...
	public static com.liferay.layout.page.template.model.LayoutPageTemplateEntry
		...
		try {
			MethodKey methodKey = new MethodKey(
				LayoutPageTemplateEntryServiceUtil.class,
				"moveLayoutPageTemplateEntry",
				_moveLayoutPageTemplateEntryParameterTypes57);
	...
	private static final Class<?>[]
		_getLayoutPageTemplateEntriesByTypeParameterTypes37 = new Class[] {
			long.class, long.class, int.class, int.class, int.class,
			com.liferay.portal.kernel.util.OrderByComparator.class
		};
	private static final Class<?>[]
	...
	private static final Class<?>[]
		_getLayoutPageTemplateEntriesCountByTypeParameterTypes54 = new Class[] {
			long.class, long.class, int.class
		};
	private static final Class<?>[]
		_getLayoutPageTemplateEntryParameterTypes55 = new Class[] {long.class};
	private static final Class<?>[]
		_getLayoutPageTemplateEntryParameterTypes56 = new Class[] {
			long.class, String.class
		};
	private static final Class<?>[]
		_moveLayoutPageTemplateEntryParameterTypes57 = new Class[] {
			long.class, long.class
		};
	private static final Class<?>[]
