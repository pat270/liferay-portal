...
create unique index IX_F94146E4 on WikiNode (groupId, ctCollectionId, uuid_[$COLUMN_LENGTH:75$]);
...
create unique index IX_FC575C07 on WikiPageResource (ctCollectionId, uuid_[$COLUMN_LENGTH:75$], groupId);