...
create index IX_BBFCFB56 on CommercePriceEntry (status, CPInstanceUuid[$COLUMN_LENGTH:75$], commercePriceListId);
...
create unique index IX_CE813A3F on CommerceTierPriceEntry (ctCollectionId, companyId, externalReferenceCode[$COLUMN_LENGTH:75$]);
