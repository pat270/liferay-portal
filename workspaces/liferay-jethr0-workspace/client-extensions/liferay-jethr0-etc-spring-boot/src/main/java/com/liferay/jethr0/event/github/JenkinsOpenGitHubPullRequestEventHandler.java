 ...
 */
public class JenkinsOpenGitHubPullRequestEventHandler
	extends BaseOpenGitHubPullRequestEventHandler {

	protected JenkinsOpenGitHubPullRequestEventHandler(
		...
		for (String testOption : getTestOptions()) {
			jobEntities.add(
				createPullRequestJobEntity(
					JobEntity.Type.JENKINS_PULL_REQUEST, 5, testOption));
		}
